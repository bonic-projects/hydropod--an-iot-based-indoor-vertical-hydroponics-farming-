  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ManualViewModel>.reactive(
      ...
      builder: (context, model, child) {
        ...
        return Scaffold(
            appBar: AppBar(
              title: const Text('Hydropod Manual'),
              centerTitle: true,
      ...
      child: Column(
        ...
        children: [
          ...
          _OtherButtons(
            ...
            isTrue: model.deviceData.servo == servoMin,
          ...
          Padding(
            ...
            child: Card(
              ...
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Ir reading: ${model.node!.ir}"),
              ),
            ),
          ),
          Row(
...
class _OtherButtons extends ViewModelWidget<ManualViewModel> {
  final String text1;
  final String text2;
...
class _ConditionButton extends ViewModelWidget<ManualViewModel> {
  final String text1;
  final String text2;
  final bool isTrue;
  final VoidCallback onTap;
...
class _WaterLevelMeter extends ViewModelWidget<ManualViewModel> {
  final int value;
...
class _PhMeter extends ViewModelWidget<ManualViewModel> {
  final double value;
...
class _ECMeter extends ViewModelWidget<ManualViewModel> {
  final double value;
...
class _GraphPlot extends ViewModelWidget<ManualViewModel> {
